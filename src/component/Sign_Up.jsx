        ...
        <div class="card-body p-5">
              ...
              <form style={{margin:" 0 auto",maxHeight: "470px"}} >
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <Link to={'/home'} className="btn btn-success btn-block btn-lg gradient-custom-4">Giriş Yap 
                    </Link>
                </div>

                <p class="text-center text-muted mt-4 mb-0">Hesabın yok mu ? <a Link to = {'/signin/'} href="#!"
                    class="fw-bold text-body"><u><Link to={'/Signin'} className="fw-bold text-body">Kayıt Ol 
                    </Link></u></a></p>
                    
                    
                    <div class="text-center text-muted mt-4 mb-0" id="gSignInWrapper">
